...
endpointyx(){    
    ...
    curl -o warp https://gitlab.com/Misaka-blog/warp-script/-/raw/main/files/warp-yxip/warp-linux-$(archAffix)
...
menu(){
    clear
    echo "#############################################################"
    echo -e "#               ${RED}WARP Endpoint IP 一键优选脚本(curl)${PLAIN}               #"
    echo -e "# ${GREEN}原作者${PLAIN}: MisakaNo の 小破站                                    #"
    echo -e "# ${GREEN}修改者${PLAIN}: Aristore                                              #"
    echo -e "# ${GREEN}博客${PLAIN}: https://www.aristore.top/                               #"
    echo "#############################################################"
    echo ""
